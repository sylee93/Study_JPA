...
import Study_JPA.Study_JPA.repository.order.query.OrderFlatDto;
import Study_JPA.Study_JPA.repository.order.query.OrderItemQueryDto;
...
public class OrderApIContorller {
    ...
    public List<OrderQueryDto> ordersV6(){
        List<OrderFlatDto> flats = orderQueryRepositor.findAllByDto_flat();
